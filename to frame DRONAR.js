...
if (RUN) {
    sel.forEach( element => {
        ...
        // const twenty_pct_FFFFFF_fill = clone(ui_control.fills)
        // twenty_pct_FFFFFF_fill[0] = {
        //     "type": "SOLID",
        //     "visible": true,
        //     "opacity": 0.2,
        //     "blendMode": "NORMAL",
        ...
        //     "boundVariables": {}
        // }
        //ui_control.fillStyleId = "S:1d5318d7926f928654d5c65767793881b9057e42,"
      
        const transparent_fill = clone(contents_frame.fills)
        transparent_fill[0] = {
            "type": "SOLID",
            "visible": true,
            "opacity": 0.0001,
        ...
        contents_frame.fills = transparent_fill
